<nav class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse min-vh-100 shadow">
    <div class="d-flex flex-column h-100 position-sticky pt-3">
        ...
        <div class="text-center mb-4">
            <img src="{{ asset('assets/logo.png') }}" alt="Logo" class="img-fluid" style="max-width: 150px; max-height: 60px;">
        ...
        <ul class="nav flex-column mb-auto">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ request()->routeIs('admin.orders') ? 'active bg-primary' : 'hover-link' }}"
